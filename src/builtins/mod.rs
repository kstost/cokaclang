...
// Sorted for binary search. Korean Hangul syllables (U+AC00–U+D7A3) have consistent
// UTF-8 byte ordering matching their code point order, so byte comparison works.
